...
namespace MXR {
    public class GoogleCardboardCam: MonoBehaviour {
        private static GoogleCardboardCam instance;
        ...
        private void SetupEyeRenderTextureDescription() {
            ...
            //Debug.LogFormat("GoogleCardboardCam.SetupEyeRenderTextureDescription(), graphicsFormat={0}",
