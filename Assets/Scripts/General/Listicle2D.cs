...
using static MXR.Anim.AbstractAnim;
using static MXR.Anim.AnimAccessTypes;
using static MXR.General.InitIDs;
using static MXR.General.ListicleDirs;
using static MXR.General.ListicleTypes;
using static MXR.Math.EasingTypes;
